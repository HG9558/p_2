...
export default defineComponent({
  ...
  setup() {
    ...
    const deleteIpAddress = (row: any) => {
      ElMessageBox.confirm('确定要删除该IP地址吗？', t('global.warning'), {
    ...
    const gridOptions = reactive<VxeGridProps>({
      ...
      columns: [
        ...
        { field: 'created_at', title: '添加时间', minWidth: 180, slots: { default: 'created_at' } },
        { field: 'created_name', title: '添加人', minWidth: 180 },
        { field: 'area', title: '地区', minWidth: 180 },
