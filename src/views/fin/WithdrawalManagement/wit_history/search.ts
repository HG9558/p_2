...
export default function useSearchPlaceholder() {
  const FormDataList = ref<any[]>([
    ...
    {
      type: 'select',
      label: i18n.global.t('routes.finance_manage_page.order_status'),
      options: [
        {
          value: '',
        ...
        {
          value: '374',
          label: i18n.global.t('routes.finance_manage_page.wit_suc')
        },
        {
          value: '375',
          label: i18n.global.t('routes.finance_manage_page.wit_error')
        }
      ],
      model: 'state',
      default: ''
