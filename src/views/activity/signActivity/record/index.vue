<template>
  <div class="app-container">
    ...
    <el-table  :data="listData">
      ...
      <el-table-column :label="t(`routes.activity.day${item}`)" align="center" :prop="`sign${item}`"  v-for="item in 7" :key="item"/>
...
import {  signRecordList } from '@/http/modules/activity'
...
export default defineComponent({
  ...
  setup() {
    ...
    const getList = () => {
      loading.value = true;
      signRecordList({ ...empty.preProcessData(queryParams), ty: '1' }).then((res: any) => {
