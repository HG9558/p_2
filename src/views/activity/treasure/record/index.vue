<template>
  <div class="app-container">
    ...
    <el-table  :data="listData">
      ...
      <el-table-column :label="t('routes.risk.recipients_time')" align="center" prop="created_at">
...
import {  treasureRecordList } from '@/http/modules/activity'
...
export default defineComponent({
  ...
  setup() {
    ...
    const getList = () => {
      loading.value = true;
      treasureRecordList({ ...empty.preProcessData(queryParams)}).then((res: any) => {
